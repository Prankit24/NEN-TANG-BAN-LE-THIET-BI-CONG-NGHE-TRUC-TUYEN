...
// =====================================================
// SESSION SERVICES (ĐÃ THÊM MỚI)
// =====================================================
builder.Services.AddDistributedMemoryCache(); // Lưu cache tạm thời trong RAM cho Session
builder.Services.AddSession(options =>
{
    options.IdleTimeout = TimeSpan.FromMinutes(20); // Thời gian hết hạn session (tùy chỉnh)
...
// =====================================================
// SESSION MIDDLEWARE (ĐÃ THÊM MỚI - ĐẶT SAU UseRouting)
// =====================================================
app.UseSession();
